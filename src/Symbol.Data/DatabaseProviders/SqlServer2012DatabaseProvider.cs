...
namespace Symbol.Data {
    ...
    /// SQLServer2012数据库提供者
    /// </summary>
    public class SqlServer2012DatabaseProvider : DatabaseProvider {
        ...
        #region ctor
        /// <summary>
        /// 创建 SqlServer2012DatabaseProvider 的实例。
        /// </summary>
        public SqlServer2012DatabaseProvider() {
        }
        #endregion
        ...
        public override IDataContext CreateDataContext(IDbConnection connection) {
            return new SqlServer2012DataContext(this, connection);
        }
        #region PreName
        /// <summary>
        ...
        #region types
        class SqlServer2012DataContext : DataContext, IDataContext {

            #region ctor
            /// <summary>
            /// 创建 SqlServer2012DataContext 的实例
            /// </summary>
            /// <param name="provider">数据库提供者</param>
            /// <param name="connection">数据库连接</param>
            public SqlServer2012DataContext(IDatabaseProvider provider, IDbConnection connection) : base(provider, connection) {
            }
            #endregion
