...
public static class EnumExtensions {
    ...
    #region fields
    private static readonly System.Collections.Concurrent.ConcurrentDictionary<string, IDictionary<string, object>> _list_define;
    ...
    static EnumExtensions() {
        _list_define = new System.Collections.Concurrent.ConcurrentDictionary<string, IDictionary<string, object>>();
    ...
    public static bool HasFlag2(
        ...
        return HasFlag2(ConvertExtensions.Convert<long>(current), ConvertExtensions.Convert<long>(value));
    }
    /// <summary>
    /// 判断current的值是否包含value（逻辑操作： (current &amp; value)==value  ）
    /// </summary>
    ...
    public static bool HasFlag2(
        ...
        return HasFlag2(ConvertExtensions.Convert<long>(current), value);
    }
    /// <summary>
    /// 判断current的值是否包含value（逻辑操作： (current &amp; value)==value  ）
    /// </summary>
    ...
    public static bool HasFlag2(
        ...
        return HasFlag2(current, ConvertExtensions.Convert<long>(value));
    }
    /// <summary>
    /// 判断current的值是否包含value（逻辑操作： (current &amp; value)==value  ）
    /// </summary>
    ...
    public static T[] ToValues<T>(
        ...
        return ConvertExtensions.Convert<T[]>(values);
    }
    #endregion
    ...
    static string ToName_Field(System.Reflection.FieldInfo fieldInfo, string key) {
        return ConstAttributeExtensions.Const(fieldInfo, key);
    }
    ...
    public static Array ToDefine(System.Type type) {
        ...
        if (!type.IsEnum)
            Throw.Argument("type", $"“{type.AssemblyQualifiedName}”必须是枚举类型");
    ...
    public static IDictionary<string, object> ToDefineObject<T>() where T : Enum {
    ...
    /// <param name="containsToName">包含ToName定义 [{key}Name]=ToName()。</param>
    /// <returns>返回定义对象。</returns>
    public static IDictionary<string, object> ToDefineObject<T>(bool lowerFirstLetter, bool containsToName) where T : Enum {
    ...
    /// <param name="type">枚举类型。</param>
    /// <returns>返回定义对象。</returns>
    public static IDictionary<string, object> ToDefineObject(System.Type type) {
    ...
    /// <returns>返回定义对象。</returns>
    public static IDictionary<string, object> ToDefineObject(System.Type type, bool lowerFirstLetter, bool containsToName) {
        Throw.CheckArgumentNull(type, "type");
        if (!type.IsEnum)
            Throw.Argument("type", $"“{type.AssemblyQualifiedName}”必须是枚举类型");
        ...
        return _list_define.GetOrAdd(key, (p) => {
            ...
            foreach (Enum item in Enum.GetValues(type)) {
                ...
                IDictionaryExtensions.SetValue(list, name, item.GetHashCode());
                if (containsToName) {
                    IDictionaryExtensions.SetValue(list, name + "Text", ToName(item));
                }
            }
            return list;
        });
