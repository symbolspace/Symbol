...
namespace Symbol.Text {
    ...
    */
    ...
    public static class Pinyin {
        ...
        public static string ToFullPinyin(
#if !net20
            this
#endif
            string text) {
        ...
        public static string ToFullPinyin(
            ...
            this
#endif
            string text, string spliter) {
            if (string.IsNullOrEmpty(text))
                return string.Empty;
            return GetPinyin(text, spliter);
...
//                        result += "Zhen";
//                    } else {
//                        for (int i = (_pinyinCode.Length - 1); i >= 0; i--) {
//                            if (_pinyinCode[i] <= chrAsc) {
//                                result += _pinyinName[i];
//                                break;
//                            }
//                        }
//                    }
...
//            return result;
        ...
        #region ToShortPinyin
        /// <summary>
        /// 转为短拼（汉字为声母，大写字母，以空格相隔）。
        /// </summary>
        /// <param name="text">当前文本。</param>
        /// <returns>返回短拼。</returns>
        public static string ToShortPinyin(
#if !net20
            this
#endif
            string text) {
            return ToShortPinyin(text, true, " ");
        }
        /// <summary>
        /// 转为短拼（汉字为声母，大写字母）。
        /// </summary>
...
#endif
            string text, string spliter) {
            return ToShortPinyin(text, true, spliter);
        }
        /// <summary>
        /// 转为短拼（汉字为声母）。
        /// </summary>
        ...
        public static string ToShortPinyin(
            ...
            this
#endif
            string text, bool upper) {
            return ToShortPinyin(text, upper, " ");
        }
        /// <summary>
        /// 转为短拼（汉字为声母）。
        /// </summary>
        ...
        public static string ToShortPinyin(
            ...
            this
#endif
            string text, bool upper, string spliter) {
            string result = string.Empty;
            if (string.IsNullOrEmpty(text))
                return string.Empty;
            return GetInitials(text, spliter, upper);
            ...
            //        result += c;
            //    } else {//累加拼音声母
            //        result += FirstLetter(c.ToString(), upper);
            //    }
            //}
            //return result;
        }
        ...
        public static string FirstLetter(
            ...
            this
#endif
            string value, bool upper) {
            if (string.IsNullOrEmpty(value))
                return string.Empty;
            return GetInitials(value.Substring(0, 1), "",upper);
            //string result = string.Empty;
            //if (value.CompareTo("吖") < 0) {
            //    result = value.Substring(0, 1);
            //} else if (value.CompareTo("八") < 0) {
            //    result = "A";
            //} else if (value.CompareTo("嚓") < 0) {
            //    result = "B";
            //} else if (value.CompareTo("咑") < 0) {
            //    result = "C";
            //} else if (value.CompareTo("妸") < 0) {
            //    result = "D";
            //} else if (value.CompareTo("发") < 0) {
            //    result = "E";
            //} else if (value.CompareTo("旮") < 0) {
            //    result = "F";
            //} else if (value.CompareTo("铪") < 0) {
            //    result = "G";
            //} else if (value.CompareTo("讥") < 0) {
            //    result = "H";
            //} else if (value.CompareTo("咔") < 0) {
            //    result = "J";
            //} else if (value.CompareTo("垃") < 0) {
            //    result = "K";
            //} else if (value.CompareTo("嘸") < 0) {
            //    result = "L";
            //} else if (value.CompareTo("拏") < 0) {
            //    result = "M";
            //} else if (value.CompareTo("噢") < 0) {
            //    result = "N";
            //} else if (value.CompareTo("妑") < 0) {
            //    result = "O";
            //} else if (value.CompareTo("七") < 0) {
            //    result = "P";
            //} else if (value.CompareTo("亽") < 0) {
            //    result = "Q";
            //} else if (value.CompareTo("仨") < 0) {
            //    result = "R";
            //} else if (value.CompareTo("他") < 0) {
            //    result = "S";
            //} else if (value.CompareTo("哇") < 0) {
            //    result = "T";
            //} else if (value.CompareTo("夕") < 0) {
            //    result = "W";
            //} else if (value.CompareTo("丫") < 0) {
            //    result = "X";
            //} else if (value.CompareTo("帀") < 0) {
            //    result = "Y";
            //} else if (value.CompareTo("咗") < 0) {
            //    result = "Z";
            //} else {
            //    result = "0";
            //}

            //return upper ? result.ToUpper() : result.ToLower();
        }
        #endregion
        ...
        public static string GetInitials(string text, string spliter, bool upper) {
            text = text.Trim();
            ...
            for (var i = 0; i < text.Length; ++i) {
                ...
                if (py != "") {
                    ...
                    string c = py.Substring(0,1);
                    builder.Append(upper ? c.ToUpper() : c.ToLower());
                }
            }
        ...
        public static string GetInitials(string text, string spliter, bool upper,  System.Text.Encoding encoding) {
            string text2 = ConvertEncoding(text, encoding, System.Text.Encoding.UTF8);
            return ConvertEncoding(GetInitials(text2, spliter, upper), System.Text.Encoding.UTF8, encoding);
        }
        #endregion
        ...
        public static string GetPinyin(string text,string spliter) {
            System.Text.StringBuilder builder = new System.Text.StringBuilder();
            for (var i = 0; i < text.Length; ++i) {
                string py = GetPinyin(text[i]);
                if (py != "") builder.Append(py);
                builder.Append(spliter);
            }
        ...
        public static string GetPinyin(string text,string spliter, System.Text.Encoding encoding) {
            string text2 = ConvertEncoding(text.Trim(), encoding, System.Text.Encoding.UTF8);
            return ConvertEncoding(GetPinyin(text2, spliter), System.Text.Encoding.UTF8, encoding);
        }
        #endregion

        #region GetChineseText
        /// <summary>
        /// 取和拼音相同的汉字列表
        /// </summary>
        ...
        public static string GetChineseText(string pinyin, System.Text.Encoding encoding) {
            string text = ConvertEncoding(pinyin, encoding, System.Text.Encoding.UTF8);
            return ConvertEncoding(GetChineseText(text), System.Text.Encoding.UTF8, encoding);
        }
        #endregion 
        #region GetPinyin
        /// <summary>
        ...
        public static string GetPinyin(char @char) {
            short hash = GetHashIndex(@char);
            for (var i = 0; i < PyHash.hashes[hash].Length; ++i) {
                short index = PyHash.hashes[hash][i];
                var pos = PyCode.codes[index].IndexOf(@char, 7);
                if (pos != -1)
        ...
        public static string GetPinyin(char @char, System.Text.Encoding encoding) {
            @char = ConvertEncoding(@char.ToString(), encoding, System.Text.Encoding.UTF8)[0];
            return ConvertEncoding(GetPinyin(@char), System.Text.Encoding.UTF8, encoding);
        }
        #endregion
        ...
        public static string ConvertEncoding(
            ...
            this
#endif
            string text, System.Text.Encoding sourceEncoding, System.Text.Encoding targetEncoding) {
            byte[] srcBytes = sourceEncoding.GetBytes(text);
            byte[] dstBytes = System.Text.Encoding.Convert(sourceEncoding, targetEncoding, srcBytes);
            return targetEncoding.GetString(dstBytes);
        }
        #endregion
