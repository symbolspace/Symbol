...
public class MethodParameterInfo : CustomAttributeProvider<System.Reflection.ParameterInfo>, IParameterInfo {
    ...
    /// 获取元顺序。
    /// </summary>
    public int MetadataToken { get { return _target?.MetadataToken ?? 0; } }
...
public class ParameterInfoBinder : System.IDisposable {
    ...
    private ConvertValueFunc _convertValue;
    ...
    /// 获取或设置值转换器。
    /// </summary>
    public ConvertValueFunc ConvertValue {
    ...
    public ParameterInfoBinder(System.Collections.Generic.IList<IParameterInfo> paramters, ConvertValueFunc convertValue, object[] datas) {
    ...
    /// </summary>
    /// <returns></returns>
    public IDictionary<string, object> ToObject() {
        var list = FastObject.As(null);
        if (_paramters == null || _paramters.Count == 0)
            return list;
        Init();
        for (int i = 0; i < _paramters.Count; i++) {
            IDictionaryExtensions.SetValue(list, _paramters[i].Name, TryGetValue(i, _paramters[i]));
        }
        return list;
    }
    #endregion
    ...
    object ConvertValue_Default(object value, System.Type type) {
        if (type.IsValueType && !TypeExtensions.IsNullableType(type)) {
            return ConvertExtensions.Convert(value, typeof(System.Nullable<>).MakeGenericType(type));
        } else {
    ...
    object TryGetValue(int index, IParameterInfo paramter) {
        ...
        if (!finded) {
            ...
            if (dataBodyAttribute != null) {
                var datas = FastObject.Combine(_bodyData);
                value = datas;
                for (int i = 0; i < _paramters.Count; i++) {
                ...
                if (!string.IsNullOrEmpty(dataBodyAttribute.InvalidKeys)) {
                    IDictionaryExtensions.RemoveKeys(datas, dataBodyAttribute.InvalidKeys.Split(',', ';', '，', '；', '|', '｜', ' '));
                }
                value = _convertValue(PreConvertValue(value, paramter.Type), paramter.Type);
                //value = _datas[0];
            }
...
partial class FastWrapper {
    ...
    /// <param name="converValue">转换数据委托，默认为ConvertExtensions.Convert。</param>
    /// <param name="datas">可用数据源。</param>
    /// <returns>返回参数列表。</returns>
    public static object[] BuildParameters(System.Type type, ConvertValueFunc converValue, params object[] datas) {
        if (type == null)
            return new object[0];
    ...
    /// <param name="datas">可用数据源。</param>
    /// <returns>返回参数列表。</returns>
    public static object[] BuildParameters(System.Reflection.PropertyInfo[] paramters, ConvertValueFunc converValue, params object[] datas) {
    ...
    /// <param name="datas">可用数据源。</param>
    /// <returns>返回参数列表。</returns>
    public static object[] BuildParameters(System.Reflection.MethodInfo methodInfo, ConvertValueFunc converValue, params object[] datas) {
        if (methodInfo == null)
            return new object[0];
    ...
    /// <param name="datas">可用数据源。</param>
    /// <returns>返回参数列表。</returns>
    public static object[] BuildParameters(System.Reflection.ParameterInfo[] paramters, ConvertValueFunc converValue, params object[] datas) {
    ...
    /// <param name="datas">可用数据源。</param>
    /// <returns>返回参数列表。</returns>
    public static object[] BuildParameters(IParameterInfo[] paramters, ConvertValueFunc converValue, params object[] datas) {
    ...
    /// <param name="datas">可用数据源。</param>
    /// <returns>返回参数列表。</returns>
    public static object[] BuildParameters(System.Collections.Generic.IList<IParameterInfo> paramters, ConvertValueFunc converValue, params object[] datas) {
        using (var binder = new ParameterInfoBinder(paramters, converValue, datas)) {
            return binder.ToArray();
        }
    }
    ...
    /// <param name="datas">可用数据源。</param>
    /// <returns>返回参数列表。</returns>
    public static IDictionary<string, object> BuildParameterObject(System.Type type, params object[] datas) {
    ...
    /// <param name="datas">可用数据源。</param>
    /// <returns>返回参数列表。</returns>
    public static IDictionary<string, object> BuildParameterObject(System.Type type, ConvertValueFunc converValue, params object[] datas) {
        if (type == null)
            return null;
    ...
    /// <param name="datas">可用数据源。</param>
    /// <returns>返回参数列表。</returns>
    public static IDictionary<string, object> BuildParameterObject(System.Reflection.PropertyInfo[] paramters, params object[] datas) {
    ...
    /// <param name="datas">可用数据源。</param>
    /// <returns>返回参数列表。</returns>
    public static IDictionary<string, object> BuildParameterObject(System.Reflection.PropertyInfo[] paramters, ConvertValueFunc converValue, params object[] datas) {
        using (var binder = new ParameterInfoBinder(PropertyParameterInfo.As(paramters), converValue, datas)) {
    ...
    /// <param name="datas">可用数据源。</param>
    /// <returns>返回参数列表。</returns>
    public static IDictionary<string, object> BuildParameterObject(System.Reflection.MethodInfo methodInfo, params object[] datas) {
    ...
    /// <param name="datas">可用数据源。</param>
    /// <returns>返回参数列表。</returns>
    public static IDictionary<string, object> BuildParameterObject(System.Reflection.MethodInfo methodInfo, ConvertValueFunc converValue, params object[] datas) {
        if (methodInfo == null)
            return null;
    ...
    public static IDictionary<string, object> BuildParameterObject(System.Reflection.ParameterInfo[] paramters, params object[] datas) {
        return BuildParameterObject(paramters, null, datas);
    }
    /// <summary>
    /// 构造参数对象。
    ...
    /// <param name="datas">可用数据源。</param>
    /// <returns>返回参数对象。</returns>
    public static IDictionary<string, object> BuildParameterObject(System.Reflection.ParameterInfo[] paramters, ConvertValueFunc converValue, params object[] datas) {
        using (var binder = new ParameterInfoBinder(MethodParameterInfo.As(paramters), converValue, datas)) {
            return binder.ToObject();
        }
    }
    ...
    /// <param name="datas">可用数据源。</param>
    /// <returns>返回参数对象。</returns>
    public static IDictionary<string, object> BuildParameterObject(IParameterInfo[] paramters, ConvertValueFunc converValue, params object[] datas) {
        using (var binder = new ParameterInfoBinder(paramters, converValue, datas)) {
            return binder.ToObject();
        }
    }
    ...
    /// <param name="datas">可用数据源。</param>
    /// <returns>返回参数对象。</returns>
    public static IDictionary<string, object> BuildParameterObject(System.Collections.Generic.IList<IParameterInfo> paramters, ConvertValueFunc converValue, params object[] datas) {
        using (var binder = new ParameterInfoBinder(paramters, converValue, datas)) {
            return binder.ToObject();
        }
    }
