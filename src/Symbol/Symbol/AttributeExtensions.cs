...
public static class AttributeExtensions {
    ...
    public static System.Collections.IList GetCustomAttributes(
        ...
        string key = string.Concat(GetKeyBefore(customAttributeProvider), "|", type.AssemblyQualifiedName, "|", inherit);
    ...
    static object GetKeyBefore(System.Reflection.ICustomAttributeProvider customAttributeProvider) {
        ...
        }
        {
            ...
            if (value != null)
                return value.DeclaringType.AssemblyQualifiedName + "/" + value;
        }
        return customAttributeProvider.GetHashCode();

    }
    static System.Collections.IList CreateList(System.Type type) {
        return (System.Collections.IList)FastObject.CreateInstance(typeof(System.Collections.Generic.List<>).MakeGenericType(type));
    }
    #endregion
