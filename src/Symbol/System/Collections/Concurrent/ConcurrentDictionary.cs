...
#region ICollection Members
        ...
        object ICollection.SyncRoot
        {
            get
            {
                throw new NotSupportedException("The SyncRoot property is not supported.");
            }
        }
        ...
        private static int DefaultConcurrencyLevel
        {
            ...
            get { return DEFAULT_CONCURRENCY_MULTIPLIER * ProcessorCount; }
        }
...
//            return key;
//#else
//            return EnvironmentHelper.GetResourceString(key);
//#endif
        }
    ...
    internal static class HashHelpers {
        ...
        {
            return (comparer == null || comparer == System.Collections.Generic.EqualityComparer<string>.Default 
                || comparer.GetType().Name== "IWellKnownStringEqualityComparer"); 
        }
        ...
        public static IEqualityComparer GetRandomizedEqualityComparer(object comparer)
        {
            ...
            if (comparer.GetType().FullName == "System.IWellKnownStringEqualityComparer") {
                return (IEqualityComparer)FastWrapper.MethodInvoke(FastWrapper.GetWarpperType("System.IWellKnownStringEqualityComparer"), "GetRandomizedEqualityComparer", comparer);
            }
        ...
        public static object GetEqualityComparerForSerialization(object comparer)
        {
            ...
            if (comparer.GetType().FullName == "System.IWellKnownStringEqualityComparer") {
                return FastWrapper.MethodInvoke(FastWrapper.GetWarpperType("System.IWellKnownStringEqualityComparer"), "GetEqualityComparerForSerialization", comparer);
            }
            //IWellKnownStringEqualityComparer cmp = comparer as IWellKnownStringEqualityComparer;
